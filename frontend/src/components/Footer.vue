  ...
  <footer class="bg-black text-white py-12 px-6">
    <div class="max-w-7xl mx-auto">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <!-- Surigao del Norte Branding -->
        <div class="flex flex-col items-center text-center">
          <!-- Circular Image -->
          <div class="w-40 h-40 rounded-full overflow-hidden mb-4 border-4 border-white shadow-xl">
            <img
              src="https://ik.imgkit.net/3vlqs5axxjf/TW-Asia/uploadedImages/Industry/Marketing/philippines-new-tourism-campaign-love-it-or-hate-it.jpg?tr=w-1200%2Cfo-auto"
              alt="Surigao del Norte"
          ...
          <div class="flex gap-3 mb-4">
            <a href="#facebook" class="text-gray-300 hover:text-white transition-colors" aria-label="Facebook">
              <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
              </svg>
            </a>
            <a href="#instagram" class="text-gray-300 hover:text-white transition-colors" aria-label="Instagram">
              <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="#twitter" class="text-gray-300 hover:text-white transition-colors" aria-label="Twitter">
              <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
